...
export default function Register() {
    ...
    if (isValid) {
      ...
      try {
        ...
        const response = await axios
          .post("https://localhost:7177/api/Regsiter", formData)
          .then((response) => {
  ...
  const googleSignInSuccess = (credentialResponse) => {
    debugger;
    ...
    <div>
      ...
      >
        <DialogTitle id="scroll-dialog-title">
          ...
          <a>
            <GoogleOAuthProvider
              clientId="277261920208-dibus5qla46amemmqut8fd4d808lvd68.apps.googleusercontent.com"
              onCredentialResponse={googleSignInSuccess}
        ...
        <DialogContent dividers={scroll === "paper"}>
          ...
          <>
            ...
            <TextField
              ...
              helperText={
                formErrors.imageFileError ? "Please upload a resume" : ""
              }
          ...
          <>
            {activeStep === 1 && (
              <>
                ...
                <br />
                <h5 className="text-primary">Enter Verification Code</h5>
                <br></br>
